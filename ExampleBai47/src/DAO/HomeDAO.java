...
{
	public static String ImportExcel(HttpServletRequest request, HttpServletResponse response, Connection conn) 
	{
	...
	public static void InsertData(Add add , Connection conn, HttpServletRequest request)
	{
		...
		try {
			...
			ps.setString(1,add.getQuestion());
			ps.setString(2,add.getOption1());
			ps.setString(3,add.getOption2());
			ps.setString(4,add.getOption3());
			ps.setString(5,add.getOption4());
			ps.setString(6,add.getCorrectans());
			ps.executeUpdate();
